...
- (AUAudioUnit *)createAudioUnitWithComponentDescription:(AudioComponentDescription)desc
                                                   error:(NSError **)error;
// The generated override must build its audio unit through this: the host's
// factory call and -loadView's self-bootstrap race, and only one audio unit may
// ever exist per view controller. `make` runs only if there is none yet.
